...
public class RealtimePlumberSchoolTest
{
  ...
  private LuceneRealtimePlumber plumber;
  private LuceneRealtimePlumberSchool realtimePlumberSchool;
  ...
  public void setUp() throws Exception
  {
    ...
    realtimePlumberSchool = new LuceneRealtimePlumberSchool(
        emitter,
    ...
    plumber = (LuceneRealtimePlumber) realtimePlumberSchool.findPlumber(schema, tuningConfig, metrics);
  }
